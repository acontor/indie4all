        ...
        <div class="row">
            <div class="col-sm">
                @if(isset($post))
                    ...
                    <div class="box">
                        <form action="{{ route('master.posts.update', $post->id) }}" method='post' enctype="multipart/form-data">
                        @method("PATCH")
                    @else
                        <div class="box-header">
                            <h1>Nuevo post</h1>
                        ...
                        <div class="box">
                            <form action="{{ route('master.posts.create') }}" method='post' enctype="multipart/form-data">
                    @endif
                        @csrf
