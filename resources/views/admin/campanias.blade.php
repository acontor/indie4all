    ...
    <script type="text/javascript">
        $(function() {
            $(".btn-ban").on('click', function() {
                ...
                let url = `http://www.iestrassierra.net/alumnado/curso2021/DAWS/daws2021a1/indie4all/admin/campania/${id}/ban`;
            ...
            $(".btn-unban").on('click', function() {
                ...
                let url = `http://www.iestrassierra.net/alumnado/curso2021/DAWS/daws2021a1/indie4all/admin/campania/${id}/unban`;
