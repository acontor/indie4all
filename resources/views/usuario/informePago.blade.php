        ...
        <div class="container">
            <div class="box">
                @if ($status == 0 )
                    ...
                    <p>Por favor contacte con algún miembro del staff o con la <a href="{{ route('usuario.desarrolladora.show', $juego->desarrolladora->id) }}" target="blank">desarrolladora</a> a cargo del jeugo.</p>
                    <p>Gracias.</p>
                @endif
                @if($status == 1)
                    ...
                    @endforeach
                    @php
                        $tipo = explode(' ', $item->description)[0];
                    @endphp
