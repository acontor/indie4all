                ...
                <div class="col-12 col-md-9">
                    <div class="list-group">
                        <ul class="list-group list-group-horizontal text-center text-uppercase font-weight-bold" style="font-size: .5rem;">
                            <a href="" id="estados" class="list-group-item list-buttons bg-dark text-white text-decoration-none">Estados</a>
                            <a href="" id="analisis-div" class="list-group-item list-buttons text-dark text-decoration-none">Análisis</a>
                        </ul>
